...
export { createExternalSlice, setExternalIdGenerator, setExternalEdgeIdGenerator, type ExternalSlice } from './externals';
...
export { createFabricSlice, setFabricIdGenerators, type FabricSlice } from './fabric';
