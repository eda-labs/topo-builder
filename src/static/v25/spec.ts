...
export interface TopologySpec {
  /**
   * Define the breakout parameters that are meant to be inherited by the breakouts referencing the template. These parameters can be overridden at the breakout level.
   */
  breakoutTemplates?: {
    /**
     * Annotations to assign to the Breakout.
     */
    annotations?: {
      [k: string]: string;
    };
    ...
    channels?: number;
    /**
     * Labels to assign to the Breakout
     */
    labels?: {
      [k: string]: string;
    };
    /**
     * The name of the BreakoutTemplate.
     */
    name: string;
    /**
     * The speed of each breakout channel
     */
    speed?: "800G" | "400G" | "200G" | "100G" | "50G" | "40G" | "25G" | "10G";
  }[];
  /**
   * Define the set of breakouts to be created/replaced/deleted. A breakout can reference a breakout template to inherit its parameters.
   */
  breakouts?: {
    /**
     * Annotations to assign to the Breakouts.
     */
    annotations?: {
      [k: string]: string;
    };
    ...
    channels?: number;
    /**
     * A list of normalized parent interface/port
     */
    interface: string[];
    /**
     * Labels to assign to the TopoBreakout
     */
    labels?: {
      [k: string]: string;
    };
    /**
     * The name of the TopoBreakout
     */
    name: string;
    /**
     * Reference to a list of TopoNodes where the parent interfaces are to be broken out
     */
    node: string[];
    /**
     * The speed of each breakout channel
    ...
    speed?: "800G" | "400G" | "200G" | "100G" | "50G" | "40G" | "25G" | "10G";
    /**
     * Reference to a template to use for this TopoBreakout.
     */
    template?: string;
  }[];
  /**
  ...
  checks?: {
    ...
    dryRun?: boolean;
    /**
     * Prompts can be configured to request user confirmation before creating, replacing, or deleting topology resources, buardless if Dry Run is enabled or not.
